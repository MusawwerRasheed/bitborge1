...
class RiskAcknowledge extends StatefulWidget {
  const RiskAcknowledge({super.key});

  @override
  State<RiskAcknowledge> createState() => _RiskAcknowledgeState();
}

class _RiskAcknowledgeState extends State<RiskAcknowledge> {
  @override
        ...
        child: Stack(
          children: [
            ...
            Padding(
              ...
              Text( textScaleFactor: 1.0, style: TextStyle(color: Colors.white), 
              ...
              Text(textScaleFactor: 1.0,  style: TextStyle(color: Colors.white), 
                'The sun is a huge ball of gases. It has a diame  it can hold millions of planets inside it. The Sun is mainly made up of hydrogen and helium gas. The surface of the Sun is known as the photosphere. The photosphere is surrounded by a thin layer of gas known as the chromospheres. Without the Sun ival.   '),    
